...
import com.thanhhc.dao.ProductDao;
...
public class ProductDaoImpl extends JDBCConnection implements ProductDao {
	...
	public void insert(Product product) {
		String sql = "INSERT INTO Product(name, price, des, cate_id,  image) VALUES (?, ?, ?, ?, ?)";
	...
	public void edit(Product product) {
		String sql = "UPDATE Product SET [name] = ?, price = ?, [des] = ?, cate_id = ?, [image] = ?  WHERE id = ?";
		Connection con = super.getConnection();
