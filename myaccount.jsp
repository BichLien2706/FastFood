		...
		<div class="row">
			<div class="col-sm-3">
				...
				<form class="form" action="${myaccount}" method="Post"
					...
					<input name="role" value="${sessionScope.account.roleId }" type="hidden" >
					<input name="id" value="${sessionScope.account.id}" type="hidden">
					...
					<div class="text-center">
						<c:url value="/image?fname=${sessionScope.account.avatar }"
							var="imgUrl"></c:url>
						<img src="${sessionScope.account.avatar }" class="avatar img-circle img-thumbnail"
							alt="avatar">
						<h6>Upload a different photo...</h6>
						<!-- <input type="file" name="avatar" class="text-center center-block file-upload"> -->
						<input name="avatar" type="file" class="form-control-file text-center center-block file-upload">
					</div>
					</hr>
					<br>
			</div>
				...
				<div class="tab-content">
					<div class="tab-pane active" id="home">
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<label for="first_name"><h4>User Name</h4></label> <input
									type="text" readonly class="form-control" name="username"
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<label for="phone"><h4>Password</h4></label> <input
									disabled type="password" class="form-control" name="password" id="phone"
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<label for="phone"><h4>Date Of Birth</h4></label> <input
									type="date" class="form-control" name="dateOfBirth" id="dateOfBirth"
									value="${sessionScope.account.dateOfBirth }"
						...
						<div class="form-group">
							...
							<div class="col-xs-6">
								<label for="phone"><h4>Address</h4></label> <input
