				...
				<form class="shopping-cart" action="#">
					<div>
									...
									<tbody>
										<c:forEach items="${sessionScope.cart}" var="map">
											...
											<tr>
												...
												<td>${map.quantity }</td>
												<td class="shop-red">$ ${map.product.price * map.quantity }</td>
												<td><a
													href="${pageContext.request.contextPath}/member/cart/remove?pId=${map.id}"><button
						...
						<div class="coupon-code">
							<div class="row">
								<div class="col-sm-4 col-md-9 sm-margin-bottom-30">
								</div>
								<div class="col-sm-3 col-md-3 col-sm-offset-5">
									<ul class="list-inline total-result">
										<li>
											<h4>Subtotal:</h4> <c:set var="total" value="${0}" /> <c:forEach
												items="${sessionScope.cart}" var="map">
												<c:set var="total"
													value="${total + map.quantity * map.product.price}" />
											</c:forEach>
										...
										<li>
											<h4>Payment:</h4>
											<div class="total-result-in">
												<a href="${pageContext.request.contextPath}/PayOrder" class="btn-u btn-u-sea-shop">Pay</a>
											</div>
